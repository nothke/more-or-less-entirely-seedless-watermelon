...
public static class AudioUtils
{
    ...
    public static AudioSource Play(this AudioClip clip, Vector3 position, float volume = 1, float pitch = 1, float spread = standardSpread, float minDistance = standardMinDistance, AudioMixerGroup mixerGroup = null)
    {
        GameObject go;
        AudioSource source;
    ...
    public static AudioSource Play(this AudioClip[] clips, Vector3 position, float volume = 1, float pitch = 1, float spread = standardSpread, float minDistance = standardMinDistance, AudioMixerGroup mixerGroup = null)
    {
    ...
    public static AudioSource CreateSource(Transform at, AudioClip clip = null, float volume = 1, float pitch = 1, bool loop = true, bool playAtStart = false,
                                            float minDistance = standardMinDistance, float spread = standardMinDistance, float spatialBlend = 1, AudioMixerGroup mixerGroup = null)
    {
